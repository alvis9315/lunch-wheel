...
- 在帳號設定一次匿名或自訂暱稱，新評論自動沿用；Google 名稱與完整信箱不會自動公開，管理者可經授權查看帳號。
...
4. 選匿名或填寫自訂暱稱，按「確認」儲存後視窗會自動關閉，新評論都沿用這個名稱。不儲存就關閉會維持原設定（新會員為匿名）。關閉或重新整理網頁後需再登入網站，最多維持兩小時；已儲存的匿名／暱稱設定會保留。
